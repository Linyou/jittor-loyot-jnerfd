...
class NerfDataset():
    def __init__(self,root_dir, batch_size, mode='train', H=0, W=0, correct_pose=[1,-1,-1], aabb_scale=None, scale=None, offset=None, img_alpha=True,to_jt=True, have_img=True, preload_shuffle=True, angle_scale=1.0):
    ...
    def load_data(self,root_dir=None):
        ...
        def read_focal_length(resolution: int, axis: str):
            if 'fl_'+axis in json_data:
                ...
                return fov_to_focal_length(resolution, self.angle_scale*json_data['camera_angle_'+axis]*180/pi)
            else:
                return 0
