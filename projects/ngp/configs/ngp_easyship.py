...
dataset_dir = '/root/workspace/nerf_datasets/Jrender_Dataset/'+exp_name
...
# dataset_angle_scale = {"Car":1.0, "Coffee":1.0, "Easyship":0.755, "Scar":1.0, "Scarf":1.0}
dataset_angle_scale = {"Car":0.9231651, "Coffee":1.0, "Easyship":0.74999744, "Scar":1.0, "Scarf":1.0}
...
dataset = dict(
    train=dict(
        ...
        angle_scale=dataset_angle_scale[exp_name],
    ),
    val=dict(
        type=dataset_type,
        root_dir=dataset_dir,
...
ckpt_path='logs/Easyship-27.92/params.pkl'
